...
internal sealed class StratzHttpRequester : IStratzRequester
{
    ...
    public StratzHttpRequester(
        ...
        IOptionsMonitor<StratzHttpRequesterOptions> optionsMonitor,
        ISerializationOptionsProvider serializationOptionsProvider,
        ILogger<StratzHttpRequester> logger)
    {
    ...
    // Bearer token is per-request because the key is read from live options (hot-reload safe).
