...
internal sealed class SteamHttpRequester : ISteamRequester
{
    ...
    private Uri BuildUri(string url, IEnumerable<KeyValuePair<string, string>>? parameters)
    {
        ...
        if (!string.IsNullOrWhiteSpace(apiKey))
            paramList.Add(new KeyValuePair<string, string>(SteamAuthenticationConstants.Parameters.Key, apiKey));
