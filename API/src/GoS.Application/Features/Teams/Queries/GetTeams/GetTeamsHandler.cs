...
internal sealed class GetTeamsHandler(IRequester<OpenDotaHttpRequesterOptions> requester, IMapper mapper) : IRequestHandler<GetTeamsQuery, IEnumerable<TeamDto>?>
{
