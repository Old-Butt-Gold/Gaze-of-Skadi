...
import { BooleanState, Behavior, Dispellable } from '../../types/common';
        ...
        >
            <div className="bg-[#101216] border border-[#2e353b] shadow-[0_10px_40px_rgba(0,0,0,0.9)] rounded-sm overflow-hidden text-sm text-[#808fa6] relative">
                ...
                <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                    <div
                        className="absolute inset-[-50%] bg-cover bg-center opacity-30 blur-3xl saturate-200"
                        style={{ backgroundImage: `url(${iconSrc})` }}
                    />
                    <div className="absolute inset-0 bg-[#101216]/85" />
                </div>

                <div className="relative z-10">
                    {/* --- Header --- */}
                    <div className="bg-black/20 backdrop-blur-sm p-3 flex gap-3 border-b border-[#2e353b] relative overflow-hidden">
                        {/* Innate Glow */}
                        {isInnate && (
                        ...
                        <div className="space-y-1 text-[11px] font-bold">
                            ...
                            {ability.bkbpierce !== null && (
                                <div className="flex gap-1">
                                    ...
                                    <span className={ability.bkbpierce === BooleanState.True ? "text-emerald-400" : "text-red-400"}>
                            ...
                            {ability.dispellable !== null && (
                                <div className="flex gap-1">
                                    ...
                                    <span className={clsx(
                                        ability.dispellable === Dispellable.Yes && "text-emerald-400",
                                        ability.dispellable === Dispellable.StrongDispelsOnly && "text-red-800",
                                        ability.dispellable === Dispellable.No && "text-red-400"
                                    )}>
