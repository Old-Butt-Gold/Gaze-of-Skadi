        ...
        <div className="w-full bg-[#15171c] border-b border-[#2e353b] relative overflow-hidden">
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4">
                ...
                <div className="flex flex-col items-center md:items-start flex-1 w-full min-w-0">
                    ...
                    {isRadiantWin ? (
                        <span className="mt-2 text-xs font-bold text-[#e7d291] uppercase tracking-widest px-2.5 py-0.5 bg-[#e7d291]/10 rounded border border-[#e7d291]/30 drop-shadow-sm">
                            Winner
                        </span>
                    ) : (
                ...
                <div className="flex flex-col items-center justify-center shrink-0 w-full md:w-auto">
                    <div className="text-xs font-bold text-[#808fa6] uppercase tracking-widest mb-3 text-center">
                    ...
                    <div className="flex flex-col items-center gap-1 mt-4">
                        ...
                        <span
                            className="text-xs font-bold text-[#58606e] uppercase tracking-wider cursor-help border-b border-dashed border-[#58606e]/50 hover:text-[#808fa6] transition-colors"
                    ...
                    {matchGeneral.league && (
                        <div className="mt-5 flex items-center justify-center gap-2 px-3 py-1.5 bg-[#1a1d24]/80 rounded-lg border border-[#e7d291]/20 backdrop-blur-sm shadow-md">
                            <span className="text-xs text-[#e7d291] font-bold uppercase tracking-wider truncate max-w-37.5 sm:max-w-62.5" title={matchGeneral.league.name}>
                                {matchGeneral.league.name}
                            </span>
                            {matchGeneral.league.tier && (
                                <>
                                    <span className="w-px h-3 bg-[#e7d291]/30" />
                                    <span className="text-xs text-[#e7d291] font-bold uppercase tracking-widest">
